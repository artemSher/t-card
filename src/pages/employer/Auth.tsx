...
import { GreenBtn, Input } from "@/components/ui";
...
export function EmployerLogin() {
  ...
  return (
    <div style={{
      minHeight: "100vh", background: `linear-gradient(135deg, #1a3a5c 0%, #2d5a87 100%)`,
      ...
      <div style={{ position: "relative", textAlign: "center", maxWidth: 400 }}>
        ...
        <button onClick={() => navigate("/employer/phone")} style={{
          background: "white", color: "#1a3a5c", fontFamily: F.semi, fontSize: 16,
